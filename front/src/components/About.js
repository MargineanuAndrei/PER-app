  ...
  render() {
    return (
      <div className="container about-wraper">
        ...
        <p>This application is a exercise made with pasion, all code is open source you can find it here: <a target="_blank" href="https://github.com/MargineanuAndrei/PER-app">Github</a></p>
